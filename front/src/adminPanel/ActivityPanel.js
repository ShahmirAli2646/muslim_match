                        ...
                        <React.Fragment>
                            {itx?.user2?.map((item, index) => (
                                ...
                                <ListItem>
                                    ...
                                    <Typography style={{ fontSize: '12px', marginRight: '20px', color: '#5b8fd' }}>{itx?.user1?.data?.first_name + ' liked ' + item?.data?.first_name}</Typography>
                                </ListItem>
                        ...
                        <React.Fragment>
                            {itx?.user2?.map((item, index) => (
                                ...
                                <ListItem>
                                    ...
                                    <Typography style={{ fontSize: '12px', marginRight: '20px', color: '#2fb9c8' }}>{itx?.user1?.data?.first_name + ' matched ' + item?.data?.first_name}</Typography>
                                </ListItem>
                        ...
                        <React.Fragment>
                            {itx?.user2?.map((item, index) => (
                                ...
                                <ListItem>
                                    ...
                                    <Typography style={{ fontSize: '12px', marginRight: '20px', color: '#2c8ca5' }}>{itx?.user1?.data?.first_name + ' viewed ' + item?.data?.first_name}</Typography>
                                </ListItem>
                    ...
                    {memberArray?.map((itx, index) => (
                        <React.Fragment>
                                <ListItem>
                                    ...
                                    <Typography style={{ fontSize: '12px', marginRight: '20px', color: '#d04185' }}>{itx?.first_name + ' joined ' }</Typography>
                                </ListItem>
                        </React.Fragment>
